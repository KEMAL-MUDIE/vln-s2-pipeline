#!/usr/bin/env python3
"""
Gate 4 Visual v73 — v72 + ranked-priority landmark prompt (Phase 1 quality improvement)

v72 BASELINE:
  GT-match: 0.990, avg_words: 26.5 (GT=26.8)
  Direction-aware approach-view Phase 1: 97.9% good rate
  Landmarks: 22.1% door/doorframe (generic), 19.2% artwork/decor

v73 FIX:
  Replace v72's direction-aware Phase 1 (gate4_v72_approach_views_dir_p1_checkpoint.json)
  with ranked-priority Phase 1 (gate4_v73_approach_views_p1_checkpoint.json).
  - Prompt ranks: artwork/decor > distinctive furniture > architecture > doors (last resort)
  - Result: artwork/decor = 40% (was 19%), door/doorframe = 11.5% (was 22%)
  - Good rate: 99.1% (was 97.9%), 0 regressions vs v72, 46 improvements
  - 3043/3979 descriptions changed (76% — significantly more distinctive landmarks)
  Everything else identical to v72 (same direction-awareness, same generation logic).

Phase 2 checkpoint: outputs/gate4_v73_phase2_checkpoint.json (FRESH — P1 data changed)
Output: outputs/datasets/val_unseen_generated_gemma_visual_v73.json.gz
"""
import asyncio
import base64
import gzip
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v73.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v73_phase2_checkpoint.json"  # FRESH — P1 data changed

#!/usr/bin/env python3
"""
Gate 4 Visual v45 — Turn suppression via prompt: "only use route turns"
...
v40 FIXES:
  ...
  Phase 2 checkpoint: outputs/gate4_v45_phase2_checkpoint.json
  Output: outputs/datasets/val_unseen_generated_gemma_visual_v45.json.gz
"""
import asyncio
import base64
import gzip
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v45.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v45_phase2_checkpoint.json"

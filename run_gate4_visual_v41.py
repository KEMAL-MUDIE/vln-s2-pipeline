#!/usr/bin/env python3
"""
Gate 4 Visual v41 — Fragment MERGE (not delete) + truncated stop fix
...
v40 FIXES:
  ...
  Phase 2 checkpoint: outputs/gate4_v41_phase2_checkpoint.json
  Output: outputs/datasets/val_unseen_generated_gemma_visual_v41.json.gz
"""
import asyncio
import base64
import gzip
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v41.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v41_phase2_checkpoint.json"
...
async def main():
    ...
    print('=== Gate 4 v41: Fix dup-stop=62 ("and stop at X" mid-instruction → "and walk to X") ===')
    ...
    print(f"  wooden:        {100*wooden_n/n:.1f}%  (GT=3.3%) ← v41 should be <1%")
    ...
    print(f"  [Note: v41: v39 + fragment MERGE (not delete) + truncated landmark attr fix]")

#!/usr/bin/env python3
"""
Gate 4 Visual v114 — Diversify "walk straight" + suppress excess "walk into the [room]".
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v114.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v114_phase2_checkpoint.json"  # v114 — diversify walk_straight + suppress excess walk_into

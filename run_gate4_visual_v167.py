...
Phase 2 checkpoint: outputs/gate4_v167_phase2_checkpoint.json (FRESH)
Output: outputs/datasets/val_unseen_generated_gemma_visual_v167.json.gz
"""
import asyncio
import base64
import gzip
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v167.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v167_phase2_checkpoint.json"  # v167: FRESH — P_DIR=0.12 + nav-verb ahead filter
...
P_DIR_ROOM_TRANS  = 0.12  # v167: calibrated from v166 measurement
                           # v164 (P_DIR=0.00): anchor%=6.1% (hallway+furniture baseline)
                           # v166 (P_DIR=0.20): anchor%=23.2% (non-hallway adds +17.1pp)
                           # v167 (P_DIR=0.12): anchor%≈6.1%+10.3%=16.4% (target GT=16.5%) ✓

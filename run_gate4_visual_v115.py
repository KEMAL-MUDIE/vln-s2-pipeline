#!/usr/bin/env python3
"""
Gate 4 Visual v115 — Restore had_pass suppression: walk_past only if [pass:] marker in route.
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v115.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v115_phase2_checkpoint.json"  # v114 — diversify walk_straight + suppress excess walk_into
...
- STYLE: VARY your motion verbs — use "go straight", "walk forward", "head forward", "go forward", "continue forward", "keep going". Do NOT repeat "walk straight" more than once. Keep instructions clean and turn-focused.
...
def clean(raw, sv):
    ...
    _ws_variants = [
        ...
        (r'\bwalk straight\b',                   ['go straight', 'walk forward', 'go forward', 'head forward', 'keep going', 'continue forward']),
    ]

#!/usr/bin/env python3
"""
Gate 4 Visual v190 -- walk_to reduction, exit boost, continue overshoot fix, filler removal.
...
Phase 2 checkpoint: outputs/gate4_v190_phase2_checkpoint.json (REUSE v180 P2 results -- assembly-only)
Output: outputs/datasets/val_unseen_generated_gemma_visual_v190.json.gz
"""
import asyncio
import base64
import gzip
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v190.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v190_phase2_checkpoint.json"  # v190: REUSE v180 P2 results -- assembly-only

#!/usr/bin/env python3
"""
Gate 4 Visual v44 — Turn overuse fix: probabilistic unanchored turn sampling
...
v40 FIXES:
  ...
  Phase 2 checkpoint: outputs/gate4_v44_phase2_checkpoint.json
  Output: outputs/datasets/val_unseen_generated_gemma_visual_v44.json.gz
"""
import asyncio
import base64
import gzip
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v44.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v44_phase2_checkpoint.json"
...
async def main():
    ...
    print('=== Gate 4 v44: Turn overuse fix — probabilistic unanchored turn sampling (P_TURN=0.55) ===')
    ...
    print(f"  wooden:        {100*wooden_n/n:.1f}%  (GT=3.3%) ← v44 should be <1%")
    ...
    print(f"  [Note: v44: fresh P2 + P_TURN_UNANCHORED=0.55 to reduce turns from 1.03→~0.65 (GT=0.59)")

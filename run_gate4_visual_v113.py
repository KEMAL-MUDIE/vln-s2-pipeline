#!/usr/bin/env python3
"""
Gate 4 Visual v113 — Structural-only suppression: remove furniture from _GENERIC_WPT_OBJ_RE.
...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v113.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v113_phase2_checkpoint.json"  # v113 — structural-only suppression in _GENERIC_WPT_OBJ_RE (remove furniture)

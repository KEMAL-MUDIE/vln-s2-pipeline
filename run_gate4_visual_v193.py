...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v193.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v193_phase2_checkpoint.json"  # v193: assembly-only, copy of v180 P2
...
async def main():
    ...
    for ep in episodes:
        ...
        def _walk_to_room_to_enter(m):
            if _v193_fix7b_rng.random() < 0.60:
                cap = m.group(0)[0].isupper()

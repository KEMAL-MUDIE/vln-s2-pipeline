#!/usr/bin/env python3
"""
Gate 4 Visual v15 — Episode-Level Landmark Control (True GT Distribution)
...
THE FIX (v15): EPISODE-LEVEL CONTROL
  - For each episode, with P_ANCHOR_EPISODE = 0.40 probability:
...
Output: outputs/datasets/val_unseen_generated_gemma_visual_v15.json.gz
"""
import asyncio
import gzip
import json
...
OUTPUT     = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v15.json.gz"
CKPT       = ROOT / "outputs" / "gate4_visual_v15_checkpoint.json"
...
def episode_selective_turns(lm_info: Dict, eid: int, p_anchor: float = P_ANCHOR_EPISODE) -> List[Dict]:
    ...
    """
    rng = random.Random(eid ^ 0xF4A7_C15E)
...
async def main():
    ...
    print("=== Gate 4 v15: Episode-Level Landmark Control ===")

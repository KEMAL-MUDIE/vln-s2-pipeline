...
OUTPUT        = ROOT / "outputs" / "datasets" / "val_unseen_generated_gemma_visual_v193b.json.gz"
...
P2_CKPT       = ROOT / "outputs" / "gate4_v193b_phase2_checkpoint.json"  # v193b: assembly-only, copy of v180 P2 (aggressive FIX7)
